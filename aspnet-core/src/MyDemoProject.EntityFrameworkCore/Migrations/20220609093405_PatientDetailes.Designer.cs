...
{
    [DbContext(typeof(MyDemoProjectDbContext))]
    [Migration("20220609093405_PatientDetailes")]
    partial class PatientDetailes
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyDemoProject.Authorization.Roles.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MyDemoProject.Authorization.Users.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("MyDemoProject.MultiTenancy.Tenant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MyDemoProject.Services.AddPatient.DtoPatient.PatientDetails", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("MyDemoProject.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("MyDemoProject.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("MyDemoProject.Authorization.Roles.Role", b =>
                {
                    b.HasOne("MyDemoProject.Authorization.Users.User", "CreatorUser")
                        .WithMany()
                        .HasForeignKey("CreatorUserId");

                    b.HasOne("MyDemoProject.Authorization.Users.User", "DeleterUser")
                        .WithMany()
                        .HasForeignKey("DeleterUserId");

                    b.HasOne("MyDemoProject.Authorization.Users.User", "LastModifierUser")
                        .WithMany()
