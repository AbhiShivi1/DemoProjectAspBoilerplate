...
{
    public abstract class MyDemoProjectWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static MyDemoProjectWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(MyDemoProjectWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<MyDemoProjectDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<MyDemoProjectDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<MyDemoProjectDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<MyDemoProjectDbContext, Task<T>> func)
        {
            T result;
